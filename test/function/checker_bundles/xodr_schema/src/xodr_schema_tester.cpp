...
#define MODULE_NAME "XodrSchemaChecker"

class cTesterXodrSchema : public ::testing::Test
{
  public:
    std::string strTestFilesDir = std::string(QC4OPENX_DBQA_XODR_SCHEMA_TEST_REF_DIR);
    std::string strWorkingDir = std::string(QC4OPENX_DBQA_XODR_SCHEMA_TEST_WORK_DIR);
};

TEST_F(cTesterXodrSchema, CmdBasic)
{
...
TEST_F(cTesterXodrSchema, CmdDefaultConfig)
{
    std::string strResultMessage;
...
TEST_F(cTesterXodrSchema, CmdConfig)
{
    std::string strResultMessage;
...
TEST_F(cTesterXodrSchema, CmdXodr)
{
    std::string strResultMessage;
...
TEST_F(cTesterXodrSchema, CmdConfigFileNotFound)
{
    std::string strResultMessage;
...
TEST_F(cTesterXodrSchema, CmdFirstArgumentWrong)
{
    std::string strResultMessage;
...
TEST_F(cTesterXodrSchema, CmdTooMuchArguments)
{
    std::string strResultMessage;
