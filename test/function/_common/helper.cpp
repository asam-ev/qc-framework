                                ...
                                const std::string strArgument)
{
    ...
    if (a_util::filesystem::exists(strTotalCommand)) {
        ...
        if (i32Res != 0) {
            strResultMessage = "Command executed with result " + std::to_string(i32Res) +
                               ". Command: '" + strTotalCommand + "'.";
    ...
    strResultMessage =
        "Command to execute was not found in any defined install directory. Command: '" +
        strTotalCommand + "'.";
                                 ...
                                 const std::string strFilePath2)
{
    ...
    while (!feof(f1) || !feof(f2)) {
        ...
        if (r1 != r2 || memcmp(buf1, buf2, r1)) {
            ...
            fclose(f2);
            strResultMessage =
                "Files '" + strFilePath1 + "' and '" + strFilePath2 + "' do not match.";
            return qc4openx::ERR_FAILED;
        }
    }
