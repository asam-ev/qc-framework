...
public:
    ...
    explicit cReportModuleWindow(cResultContainer* container,
                                 const std::string& reportModuleName,
                                 QWidget* parent = 0);
...
private:
	...
	void ValidateInputFile(cCheckerBundle* const bundle, QMap<QString, QString>* fileReplacementMap, const std::string& parameter, const std::string& fileName, const std::string& filter) const;
};