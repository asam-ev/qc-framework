...
DOMElement* cParameterContainer::CreateNode(DOMDocument* pDOMDocResultDocument, const std::string& name, const std::string& value) const
{
...
std::string cParameterContainer::GetParam(const std::string& name,
...
std::vector<std::string> cParameterContainer::GetParams() const
{
    ...
    for (std::map<std::string, std::string>::const_iterator it = m_Parameters.cbegin();
