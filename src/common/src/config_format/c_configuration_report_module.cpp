...
cConfigurationReportModule::cConfigurationReportModule(const std::string &applicationName)
    : cConfigurationReportModule()
{
    strApplication = applicationName;
}

cConfigurationReportModule *cConfigurationReportModule::ParseConfigurationReportModule(DOMNode *const pXMLNode,
...
void cConfigurationReportModule::ProcessDomNode(DOMNode *nodeToProcess,
                                                cConfigurationReportModule *currentCheckerBundle)
{
