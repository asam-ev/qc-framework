...
class cProcessView : public QTreeWidget
{
  ...
  private:
    ...
    void AddCheckerBundleItemToRoot(c_configuration_checker_bundle *const checkerBundle, const bool expand = false);

    // Add checker item to checker bundle item
    void AddCheckerItem(QTreeWidgetItem *parentCheckerBundleItem, c_configuration_checker *const checker);
