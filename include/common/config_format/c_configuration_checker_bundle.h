...
class cConfigurationCheckerBundle
{
  public:
    ...
    static cConfigurationCheckerBundle *ParseConfigurationCheckerBundle(DOMNode *const pXMLNode,
    ...
    // Adds a Checker
    cConfigurationChecker *AddChecker(const std::string &checkerId, eIssueLevel minLevel = INFO_LVL,
