...
#ifndef c_configuration_h__
#define c_configuration .h__
...
class cConfiguration
{
  ...
  public:
    ...
    std::vector<c_configuration_checker_bundle *> GetCheckerBundles() const;
    ...
    c_configuration_checker_bundle *GetCheckerBundleByName(const std::string &applicationName);

    // Adds a ReportModule
    cConfigurationReportModule *AddReportModule(const std::string &applicationName);

    // Adds a CheckerBundle
    c_configuration_checker_bundle *AddCheckerBundle(const std::string &applicationName);
  ...
  protected:
    ...
    std::vector<c_configuration_checker_bundle *> m_checkerBundles;
