...
public:
	...
	*
	*/
	cCheckerBundle(const std::string& checkerName) :
	...
	*/
	...
	// Adds a new checker
	cChecker* CreateChecker(const std::string& checkerId, const std::string& strDescription="", const std::string& strSummary="");

	/*
	* Adds an amout of issues to the checker bundle
	*/
	cChecker* CreateCheckerWithIssues(const std::string& strCheckerId, const std::string& strDescription, eIssueLevel issueLevel, std::map<std::string, std::string> m_Issues);
...
protected:
	...
	* Creates a new checker bundle
	*/
	cCheckerBundle(const std::string& checkerName, const std::string& checkerSummary,
        const std::string& fileName, const std::string& filepath, const std::string& description,
        const std::string& version, const std::string& date) :
		m_CheckerName(checkerName), m_CheckerSummary(checkerSummary), m_Description(description), m_FileName(fileName), m_FilePath(filepath),
		m_BuildVersion(version), m_BuildDate(date) {}
