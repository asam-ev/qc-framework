...
public:
	...
	*/
	cInertialLocation(double x, double y, double z) :	cExtendedInformation("InertialLocation"),
																				m_X(x), m_Y(y), m_Z(z),
																				m_H(0.0), m_P(0.0), m_R(0.0)
	{
	}
	...
	*/
	cInertialLocation(double x, double y, double z, double head, double pitch, double roll) :
																				cExtendedInformation("InertialLocation"),
																				m_X(x), m_Y(y), m_Z(z),
																				m_H(head), m_P(pitch), m_R(roll)
	{
	}
	...
	static cInertialLocation* ParseFromXML(XERCES_CPP_NAMESPACE::DOMNode* pXMLNode, XERCES_CPP_NAMESPACE::DOMElement* pXMLElement);
