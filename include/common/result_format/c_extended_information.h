...
public:
	...
	* 
	*/
	cExtendedInformation(const std::string& tagName="") :
		m_TagName(tagName) {}
...
protected:
    ...
    XERCES_CPP_NAMESPACE::DOMElement* CreateExtendedInformationXMLNode(XERCES_CPP_NAMESPACE::DOMDocument * p_resultDocument);
};
